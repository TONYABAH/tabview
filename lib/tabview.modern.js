...
const TabView = function () {
  ...
  function createTabButton(linkId, tabId, {
    ...
    tabBtn.style.display = 'block'; // tabBtn.style.transform = 'rotate(-5deg)';
  ...
  function createLabel(text, title) {
    ...
    label.style.verticalAlign = 'middle'; // label.style.padding = '0';
  ...
  function createTabBarWraper() {
    ...
    tabbarContainer.style.height = '100%'; // tabbarContainer.style.height = '100%';
  ...
  function createTabBar() {
    ...
    tabBar.style.position = 'absolute'; // tabBar.style.width = '100%';
  ...
  function createButton(name, text, float) {
    ...
    btn.style.padding = '2px'; // btn.style.paddingLeft = btn.style.paddingRight = '2px';
  ...
  function createImage(options) {
    ...
    img.style.marginRight = '2px'; // img.style.color = '#b00';
  ...
  function applySelection(el, options) {
    ...
    for (let i = 0; i < tablinks.length; i++) {
      ...
      tablinks[i].style.boxShadow = '1px 1px 2px 1px #333'; // tablinks[i].style.margin = '';
    }

    el.classList.add('active');
    el.style.background = options.activeBg;
    el.style.color = options.activecolor;
    el.style.boxShadow = '4px 4px 16px 2px #333'; // el.style.marginRight = '1px';
  }
  ...
  const createTabs = function createTabs(el, options) {
    ...
    function init(el, options) {
      ...
      tabBarWraper.append(tabBar); // tabBarWraper.appendChild(addBtn);
