(function (global, factory) {
  ...
  (global = global || self, global.TabView = factory());
}(this, (function () {
  ...
  var TabView = function () {
    ...
    function createLinkButton(linkId, tabId, _ref) {
    ...
    var createTabs = function createTabs(el, options) {
      ...
      function add(options) {
        ...
        var length = Object.keys(buttons).length;
        var tabId = options.tabId || randomId();
        var buttonId = "link-btn-" + randomId(); // tabId,
